    ...
    <header :class="Topclass">
        ...
        <b-modal id="login" class="modal" hide-footer>
            ...
            <div class="modalcontainer">
                <div class="loginform">
                    <label for="id"><i class="bi-file-person" />아이디</label>
        ...
        <b-modal id="member" class="modal" hide-footer>
            ...
            <div class="modalcontainer">
                ...
                <b-form-group
                    ...
                    label="이메일 수신"
                    label-for="mailing"
                    description="※이메일 수신을 허락하면 알림이 갑니다"
                    >
                    <b-form-radio
                    value="Y"
                    v-model="form.mail"
                    ...
                    >
                    <b-form-checkbox value="product"
                    v-model="form.checkedtype">제품디자인</b-form-checkbox>
                    <b-form-checkbox value="vitual"
                    v-model="form.checkedtype">시각디자인</b-form-checkbox>
                    <b-form-checkbox value="3Dprinting"
                    v-model="form.checkedtype">3D프린팅</b-form-checkbox>
                    </b-form-group>
...
export default {
    data() {
        return{
            menulists: [
                { menutext: "소개", link: "/company"},
                { menutext: "디자인 과정", link: "/movieclass"},
                { menutext: "작업물", link: "/book"},
                { menutext: "갤러리", link: "/classsample"},
                { menutext: "커뮤니티", link: "/reference"},
            ],
            form: {
                id:"",
                pass:"",
